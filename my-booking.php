                        ...
                        <div class="profile_wrap">
                            ...
                            <div class="my_vehicles_list">
                                <ul class="vehicle_listing">
                                    <?php 
$useremail=$_SESSION['login'];
 $sql = "SELECT tblvehicles.Vimage1 as Vimage1,tblvehicles.VehiclesTitle,tblvehicles.id as vid,tblbrands.BrandName,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.Status,tblvehicles.PricePerDay,DATEDIFF(tblbooking.ToDate,tblbooking.FromDate) as totaldays,tblbooking.BookingNumber,tblbooking.Return  from tblbooking join tblvehicles on tblbooking.VehicleId=tblvehicles.id join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblbooking.userEmail=:useremail order by tblbooking.id desc";
$query = $dbh -> prepare($sql);
$query-> bindParam(':useremail', $useremail, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
{  ?>
                ...
                { ?>
                                        ...
                                        <div class="vehicle_status"> <a href="#"
                                                class="btn outline btn-xs active-btn">Booked</a>
                                        ...
                                        <?php if($result->Return==1)
                { ?>


                                        <div class="vehicle_status"> <a href="#"
                                                class="btn outline btn-xs active-btn">Returned</a>
                                            <div class="clearfix"></div>
                                        </div>

                                        <?php } else if($result->Return==2) { ?>
                                        <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Pending
                                                Return</a>
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <?php } else { ?>
                                        <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Returned
                                                yet</a>
                                            <div class="clearfix"></div>
                                        </div>
                                        <?php } ?>
                                    ...
                                    <a href="payment.php" class="btn outline btn-xs">Pay Here</a>
